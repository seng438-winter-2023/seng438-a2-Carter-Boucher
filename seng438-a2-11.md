...
|-------------------------------------------------|--------------|---------------------------------------------|--------|
| intersects(double lower, double upper)          | 3            | testintersectsBoundaryValueTouching()       | P      |
...
| equals(java.lang.Object obj)                    | 1            | testequalsExactRange()                      | P      |
| equals(java.lang.Object obj)                    | 1            | testequalsUpperNotEqual()                   | F      |
| equals(java.lang.Object obj)                    | 1            | testequalsLowerNotEqual()                   | P      |
| equals(java.lang.Object obj)                    | 1            | testequalsRangeNotEqual()                   | P      |
...
| expand(Range range, double lowerMargin, double upperMargin) | 3            | expandToIncludeLowerBound()                      | F      |
| expand(Range range, double lowerMargin, double upperMargin) | 3            | expandToIncludeUpperBound()                      | F      |
| expand(Range range, double lowerMargin, double upperMargin) | 3            | expandToIncludeDontChange()                      | F      |
| expand(Range range, double lowerMargin, double upperMargin) | 3            | expandToIncludeUpperBoundDontChange()            | F      |
| expand(Range range, double lowerMargin, double upperMargin) | 3            | expandToIncludeDontBound()                       | F      |
|||||
